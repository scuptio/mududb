...
mod tests {
    ...
    fn ok_roundtrip() {
        ...
        let (decoded, used) = deserialize_from::<UniQueryReturn>(&bytes).unwrap();
    ...
    fn err_roundtrip() {
        ...
        let bytes = serialize_to_vec(&value).unwrap();
        let (decoded, _) = deserialize_from::<UniQueryReturn>(&bytes).unwrap();
    ...
    fn rejects_unknown_tag() {
        ...
        assert!(deserialize_from::<UniQueryReturn>(&bytes).is_err());
    }
