...
#[test]
fn expect_u128_ok() {
    let value = UniScalarValue::from_u128(42u128);
    assert_eq!(value.expect_u128(), 42u128);
}

#[test]
fn expect_i128_ok() {
    let value = UniScalarValue::from_i128(-42i128);
    assert_eq!(value.expect_i128(), -42i128);
}
