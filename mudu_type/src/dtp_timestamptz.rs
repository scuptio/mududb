...
pub struct DTPTimestampTz {
    precision: u8,
}

impl Default for DTPTimestampTz {
    fn default() -> Self {
        Self { precision: 6 }
    }
}
...
impl DTPDyn for DTPTimestampTz {
    ...
    fn name(&self) -> String {
        format!("{}({})", DatTypeID::TimestampTz.name(), self.precision)
    }
}

impl DTPStatic for DTPTimestampTz {}
