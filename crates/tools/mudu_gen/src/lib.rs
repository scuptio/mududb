...
//! language-specific bindings and entity code for Rust, C#, AssemblyScript and
//! Python.
...
/// Static SQL checking (`mgen check-sql`): SQL literal extractors and the
/// per-language check driver.
pub mod src_check;
