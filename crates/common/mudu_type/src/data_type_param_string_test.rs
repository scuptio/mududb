...
mod tests {
    ...
    fn string_new_and_length() {
        let s = DataTypeParamString::new(42);
        assert_eq!(s.length(), 42);
    }

    #[test]
    fn string_default_is_zero() {
        let s = DataTypeParamString::default();
        assert_eq!(s.length(), 0);
    }

    #[test]
    fn string_fixed_length_is_false() {
        let s = DataTypeParamString::new(10);
    ...
    fn string_compare_orders_fixed_before_var() {
        ...
        let a = DataTypeParamString::new(5);
        let b = DataTypeParamString::new(10);
    ...
    fn string_json_roundtrip() {
        let s = DataTypeParamString::new(7);
        let json = s.se_to_json().unwrap();
        let mut restored = DataTypeParamString::default();
    ...
    fn string_name_is_non_empty() {
        let s = DataTypeParamString::new(3);
