...
mod tests {
    ...
    #[tokio::test]
    async fn async_host_get_without_task_context_returns_decodable_error() {
    ...
    #[tokio::test]
    async fn async_host_put_without_task_context_returns_decodable_error() {
    ...
    #[tokio::test]
    async fn async_host_delete_without_task_context_returns_decodable_error() {
    ...
    #[tokio::test]
    async fn async_host_range_without_task_context_returns_decodable_error() {
    ...
    #[tokio::test]
    async fn async_host_fetch_malformed_cursor_returns_uni_error() {
        let output = async_host_fetch(vec![]).await;
        assert!(!output.is_empty());
