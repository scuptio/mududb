...
pub trait Runtime: Send + Sync {
    ...
    /// Applies initdb DDL that startup auto-load deferred (see
    /// [`crate::service::runtime_opt::RuntimeOpt::defer_initdb`]). Runtimes
    /// with no deferred work drain to a no-op.
