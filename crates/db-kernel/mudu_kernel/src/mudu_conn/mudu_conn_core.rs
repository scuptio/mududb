...
impl MuduConnCore {
    ...
    pub async fn describe_stmt(
        ...
        stmt: &StmtType,
        current_schema: &str,
    ) -> RS<Arc<TupleFieldDesc>> {
        let desc = Describer::describe(self.meta_mgr.as_ref(), stmt, current_schema).await?;
        Ok(Arc::new(desc))
    }
    ...
    pub async fn query(
        ...
        let (rows, desc) = self
            .query_rows(stmt, params, tx_mgr, x_contract, current_schema)
            .await?;
    ...
    pub async fn query_rows(
        ...
        self.query_inner(stmt, params, tx_mgr, x_contract, current_schema)
            .await
    }
    ...
    pub async fn execute(
        ...
        scoped_task_trace!();
        self.execute_inner(stmt, params, tx_mgr, x_contract, current_schema)
            .await
    }
    ...
    async fn query_inner(
        ...
        let bound = {
            ...
            Binder::new(self.meta_mgr.clone(), current_schema.to_string())
