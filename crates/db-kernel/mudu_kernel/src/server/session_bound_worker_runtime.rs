...
impl WorkerLocal for SessionBoundWorkerRuntime {
    ...
    async fn query(
        ...
        self.worker.query(oid, app_name, sql, param).await
    }
    ...
    async fn relation_get(
        ...
        self.worker
            .relation_get_in_session(session_id, app_name, table, key, select)
            .await
    }
    ...
    async fn relation_update(
        ...
        self.worker
            .relation_update_in_session(session_id, app_name, table, key, values, deltas)
            .await
    }
    ...
    async fn relation_insert(
        ...
        self.worker
            .relation_insert_in_session(session_id, app_name, table, key, values)
            .await
    }
    ...
    async fn execute(
        ...
        self.worker.execute(oid, app_name, sql, param).await
    }
    ...
    async fn batch(
        ...
        self.worker.batch(oid, app_name, sql, param).await
    }
}
