...
use crate::sync_api as api_impl_sync;

#[::uniffi::export]
/// UniFFI synchronous `query` entry point.
...
#[::uniffi::export]
/// UniFFI synchronous `fetch` entry point.
...
#[::uniffi::export]
/// UniFFI synchronous `command` entry point.
...
#[::uniffi::export]
/// UniFFI synchronous `batch` entry point.
...
#[::uniffi::export]
/// UniFFI synchronous `open` entry point.
...
#[::uniffi::export]
/// UniFFI synchronous `close` entry point.
...
#[::uniffi::export]
/// UniFFI synchronous `get` entry point.
...
#[::uniffi::export]
/// UniFFI synchronous `put` entry point.
...
#[::uniffi::export]
/// UniFFI synchronous `range` entry point.
