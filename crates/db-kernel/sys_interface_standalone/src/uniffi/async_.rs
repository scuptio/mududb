...
use crate::async_api as api_impl_async;

#[::uniffi::export(async_runtime = "tokio")]
/// UniFFI asynchronous `query` entry point.
...
#[::uniffi::export(async_runtime = "tokio")]
/// UniFFI asynchronous `fetch` entry point.
...
#[::uniffi::export(async_runtime = "tokio")]
/// UniFFI asynchronous `command` entry point.
...
#[::uniffi::export(async_runtime = "tokio")]
/// UniFFI asynchronous `batch` entry point.
...
#[::uniffi::export(async_runtime = "tokio")]
/// UniFFI asynchronous `open` entry point.
...
#[::uniffi::export(async_runtime = "tokio")]
/// UniFFI asynchronous `close` entry point.
...
#[::uniffi::export(async_runtime = "tokio")]
/// UniFFI asynchronous `get` entry point.
...
#[::uniffi::export(async_runtime = "tokio")]
/// UniFFI asynchronous `put` entry point.
...
#[::uniffi::export(async_runtime = "tokio")]
/// UniFFI asynchronous `range` entry point.
