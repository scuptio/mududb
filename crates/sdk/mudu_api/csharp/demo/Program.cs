...
var queryResult = global::mududb.Mudu.Query(new UniQueryArgv
{
    ...
    ParamList = new UniSqlParam
    {
        Params = new()
        {
            ...
            {
                Inner = new mududb.types.UniScalarValueI32
                {
                    Inner = 10
                }
            }
...
{
    var id = ((mududb.types.UniScalarValueI64)((mududb.types.UniDataValueScalar)row.Fields[0]).Inner).Inner;
    var name = ((mududb.types.UniScalarValueString)((mududb.types.UniDataValueScalar)row.Fields[1]).Inner).Inner;
    var score = ((mududb.types.UniScalarValueI64)((mududb.types.UniDataValueScalar)row.Fields[2]).Inner).Inner;
...
{
    var response = global::mududb.Mudu.Command(new UniCommandArgv
    {
        Oid = new UniOid { H = 0, L = 0 },
