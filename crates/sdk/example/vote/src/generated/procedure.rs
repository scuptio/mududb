    ...
    wit_bindgen::generate!({
        ...
        r##"package mudu:mp2-get-vote-result;
            world mudu-app-mp2-get-vote-result {
                export mp2-get-vote-result: async func(param:list<u8>) -> list<u8>;
            }
        "##,
        async: true
    });
    ...
    wit_bindgen::generate!({
        ...
        r##"package mudu:mp2-get-voting-history;
            world mudu-app-mp2-get-voting-history {
                export mp2-get-voting-history: async func(param:list<u8>) -> list<u8>;
            }
        "##,
        async: true
    });
    ...
    wit_bindgen::generate!({
        ...
        r##"package mudu:mp2-create-vote;
            world mudu-app-mp2-create-vote {
                export mp2-create-vote: async func(param:list<u8>) -> list<u8>;
            }
        "##,
        async: true
    });
    ...
    wit_bindgen::generate!({
        ...
        r##"package mudu:mp2-cast-vote;
            world mudu-app-mp2-cast-vote {
                export mp2-cast-vote: async func(param:list<u8>) -> list<u8>;
            }
        "##,
        async: true
    });
    ...
    wit_bindgen::generate!({
        ...
        r##"package mudu:mp2-add-option;
            world mudu-app-mp2-add-option {
                export mp2-add-option: async func(param:list<u8>) -> list<u8>;
            }
        "##,
        async: true
    });
    ...
    wit_bindgen::generate!({
        ...
        r##"package mudu:mp2-withdraw-vote;
            world mudu-app-mp2-withdraw-vote {
                export mp2-withdraw-vote: async func(param:list<u8>) -> list<u8>;
            }
        "##,
        async: true
    });
