...
mod tests {
    ...
    fn i64_desc() -> DatumDesc {
        DatumDesc::new("y".to_string(), DataType::new_no_param(TypeFamily::I64))
    }
    ...
    fn vec_dyn_datum_to_binary_matching_length() {
        let typed = TypedBin::new(TypeFamily::I64, vec![0, 0, 0, 0, 0, 0, 0, 7]);
        let datum: &dyn DatumDyn = &typed;
    ...
    fn vec_dyn_datum_tuple_desc_with_matching_field_names() {
        ...
        assert_eq!(desc.fields()[0].type_family(), TypeFamily::I32);
    }
    ...
    fn vec_dyn_datum_tuple_desc_supports_multiple_fields() {
        let a = TypedBin::new(TypeFamily::I32, vec![0, 0, 0, 1]);
        let b = TypedBin::new(TypeFamily::I64, vec![0, 0, 0, 0, 0, 0, 0, 2]);
        ...
        assert_eq!(desc.fields()[1].type_family(), TypeFamily::I64);
    }
}
