...
pub fn mudu_argv_desc_proc_mtp()  -> &'static ::mududb::contract::tuple::tuple_field_desc::TupleFieldDesc {
...
pub fn mudu_result_desc_proc_mtp() -> &'static ::mududb::contract::tuple::tuple_field_desc::TupleFieldDesc {
