...
use crate::data_type::dt_impl::lang::utils::{dat_type_id_2_lang_type_name, lang_type_name_2_dat_type_id};
...
lazy_static!(
    ...
    static ref _name2id:HashMap<String,(DatTypeID, Vec<DatTypeID>)> = lang_type_name_2_dat_type_id(&_id_lang_type_name);
);
