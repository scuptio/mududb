...
mod tests {
    ...
    async fn ycsb_sync_procedures_roundtrip_against_standalone_adapter() {
        ...
        ycsb_insert(xid, "u1".to_string(), "v1".to_string()).await.unwrap();
        ycsb_insert(xid, "u2".to_string(), "v2".to_string()).await.unwrap();

        assert_eq!(ycsb_read(xid, "u1".to_string()).unwrap(), "v1");

        ycsb_update(xid, "u1".to_string(), "v3".to_string()).await.unwrap();
...
pub fn mudu_argv_desc_ycsb_read()  -> &'static ::mududb::contract::tuple::tuple_field_desc::TupleFieldDesc {
...
pub fn mudu_result_desc_ycsb_read() -> &'static ::mududb::contract::tuple::tuple_field_desc::TupleFieldDesc {
...
pub fn mudu_argv_desc_ycsb_update()  -> &'static ::mududb::contract::tuple::tuple_field_desc::TupleFieldDesc {
    static ARGV_DESC: std::sync::OnceLock<::mududb::contract::tuple::tuple_field_desc::TupleFieldDesc> =
        std::sync::OnceLock::new();
    ARGV_DESC.get_or_init(||
        {
...
pub fn mudu_result_desc_ycsb_update() -> &'static ::mududb::contract::tuple::tuple_field_desc::TupleFieldDesc {
    static RESULT_DESC: std::sync::OnceLock<::mududb::contract::tuple::tuple_field_desc::TupleFieldDesc> =
        std::sync::OnceLock::new();
    RESULT_DESC.get_or_init(||
        {
...
pub fn mudu_argv_desc_ycsb_read_modify_write()  -> &'static ::mududb::contract::tuple::tuple_field_desc::TupleFieldDesc {
    static ARGV_DESC: std::sync::OnceLock<::mududb::contract::tuple::tuple_field_desc::TupleFieldDesc> =
        std::sync::OnceLock::new();
    ARGV_DESC.get_or_init(||
        {
...
pub fn mudu_result_desc_ycsb_read_modify_write() -> &'static ::mududb::contract::tuple::tuple_field_desc::TupleFieldDesc {
    static RESULT_DESC: std::sync::OnceLock<::mududb::contract::tuple::tuple_field_desc::TupleFieldDesc> =
        std::sync::OnceLock::new();
    RESULT_DESC.get_or_init(||
        {
...
pub fn mudu_proc_desc_ycsb_read_modify_write()  -> &'static ::mududb::contract::procedure::proc_desc::ProcDesc {
    static _PROC_DESC: std::sync::OnceLock<
        ::mududb::contract::procedure::proc_desc::ProcDesc,
    > = std::sync::OnceLock::new();
    _PROC_DESC
