pub mod object {
    ...
    impl Stock {
        ...
        pub fn set_s_i_id(&mut self, s_i_id: i32) {
            self.s_i_id.update(s_i_id)
        }

        pub fn get_s_i_id(&self) -> &Option<i32> {
            self.s_i_id.get()
        }

        pub fn set_s_w_id(&mut self, s_w_id: i32) {
            self.s_w_id.update(s_w_id)
        }

        pub fn get_s_w_id(&self) -> &Option<i32> {
            self.s_w_id.get()
        }

        pub fn set_s_quantity(&mut self, s_quantity: i32) {
            self.s_quantity.update(s_quantity)
        }

        pub fn get_s_quantity(&self) -> &Option<i32> {
            self.s_quantity.get()
        }

        pub fn set_s_ytd(&mut self, s_ytd: i32) {
            self.s_ytd.update(s_ytd)
        }

        pub fn get_s_ytd(&self) -> &Option<i32> {
            self.s_ytd.get()
        }

        pub fn set_s_order_cnt(&mut self, s_order_cnt: i32) {
            self.s_order_cnt.update(s_order_cnt)
        }

        pub fn get_s_order_cnt(&self) -> &Option<i32> {
            self.s_order_cnt.get()
        }

        pub fn set_s_remote_cnt(&mut self, s_remote_cnt: i32) {
            self.s_remote_cnt.update(s_remote_cnt)
        }

        pub fn get_s_remote_cnt(&self) -> &Option<i32> {
    ...
    impl Datum for Stock {
        fn data_type() -> DataType {
            ...
            ONCE_LOCK
                .get_or_init(entity_utils::entity_data_type::<Stock>)
                .clone()
        }
    ...
    impl Entity for Stock {
        ...
        fn get_field_binary(&self, field: &str) -> RS<Option<Vec<u8>>> {
            match field {
                S_I_ID => attr_field_access::attr_get_binary::<_>(self.s_i_id.get()),

                S_W_ID => attr_field_access::attr_get_binary::<_>(self.s_w_id.get()),

                S_QUANTITY => attr_field_access::attr_get_binary::<_>(self.s_quantity.get()),

                S_YTD => attr_field_access::attr_get_binary::<_>(self.s_ytd.get()),

                S_ORDER_CNT => attr_field_access::attr_get_binary::<_>(self.s_order_cnt.get()),
        ...
        fn get_field_value(&self, field: &str) -> RS<Option<DataValue>> {
            match field {
                S_I_ID => attr_field_access::attr_get_value::<_>(self.s_i_id.get()),

                S_W_ID => attr_field_access::attr_get_value::<_>(self.s_w_id.get()),

                S_QUANTITY => attr_field_access::attr_get_value::<_>(self.s_quantity.get()),

                S_YTD => attr_field_access::attr_get_value::<_>(self.s_ytd.get()),

                S_ORDER_CNT => attr_field_access::attr_get_value::<_>(self.s_order_cnt.get()),
