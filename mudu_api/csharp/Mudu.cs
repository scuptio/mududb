...
global using UniDataType = Universal.UniDataType;
global using UniDataValue = Universal.UniDataValue;
global using UniError = Universal.UniError;
global using UniFsDirent = Universal.UniFsDirent;
global using UniFsOpenArgv = Universal.UniFsOpenArgv;
global using UniFsStat = Universal.UniFsStat;
global using UniMessage = Universal.UniMessage;
global using UniOid = Universal.UniOid;
global using UniScalar = Universal.UniScalar;
global using UniScalarValue = Universal.UniScalarValue;
