// Generated-style root types for the synchronous mududb:api world.
#nullable enable

namespace ApiWorld {

    public interface IApiWorld {
    }
    ...
    public readonly struct Result<TOk, TErr>
    {
        ...
        public TOk AsOk
        {
            get
            {
                ...
                throw new global::System.ArgumentException("expected Ok, got " + Tag);
            }
        }
