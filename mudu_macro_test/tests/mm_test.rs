...
mod tests {
    ...
    pub fn example(xid: XID, a: i32, b: i64, c: String) -> RS<(i64, String)> {
        Ok((
            a as i64 + b + 1,
            format!("c={}, {} function invoked", c, xid),
        ))
    }
    ...
    pub fn example_vec(xid: XID, a: i32, b: Vec<i64>) -> RS<(Vec<i64>, String)> {
        Ok((
            vec![a as i64, (a + 1) as i64],
            format!("a {}, b:{:?}, {} function invoked", a, b, xid),
        ))
    }
    ...
    fn test_mudu_macro_macro_mp2() {
        ...
        let argv = ProcedureParam::from_datum_vec(
            0,
            &[&32i32, &64i64, &"s".to_string()],
